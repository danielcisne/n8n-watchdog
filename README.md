...
To run this dashboard in a local development environment:

1. **Clone the repository:** ```bash
   git clone [https://github.com/danielcisne/n8n-watchdog.git](https://github.com/danielcisne/n8n-watchdog.git)